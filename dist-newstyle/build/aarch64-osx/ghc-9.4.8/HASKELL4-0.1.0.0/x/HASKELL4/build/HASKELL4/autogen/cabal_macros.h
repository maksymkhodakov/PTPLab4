...
/* package HASKELL4-0.1.0.0 */
#ifndef VERSION_HASKELL4
#define VERSION_HASKELL4 "0.1.0.0"
#endif /* VERSION_HASKELL4 */
#ifndef MIN_VERSION_HASKELL4
#define MIN_VERSION_HASKELL4(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HASKELL4 */
...
#define CURRENT_COMPONENT_ID "HASKELL4-0.1.0.0-inplace-HASKELL4"
